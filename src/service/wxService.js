...
class WxService {
  ...
  async getConfig() {
    ...
    this.config.appId = data.data.appId
    this.config.timestamp = data.data.timestamp
    this.config.signature = data.data.signature
    this.config.nonceStr = data.data.nonceStr
  }
